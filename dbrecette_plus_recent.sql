...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2016 at 01:48 PM
...
(1, 1, 1, 'C:\\Users\\Admin\\Documents\\NetBeansProjects\\SiteWeb-Recette\\web\\images\\pain1.jpg'),
(2, 1, 2, '\\images\\pain2.jpg'),
(3, 1, 3, 'C:\\wamp64\\www\\images\\pain_3.jpg'),
(4, 2, 1, '\\web\\images\\biscuit-canneberge.jpg'),
(5, 2, 2, 'C:\\wamp64\\www\\images\\pain 3.jpg');
...
CREATE TABLE `ingredients` (
  ...
  `id_type_unite` int(11) DEFAULT NULL,
  `ingredient` text NOT NULL,
  `position` int(11) NOT NULL,
  `facultatif` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `ingredients` (`id_ingredient`, `id_recette`, `quantite`, `id_type_unite`, `ingredient`, `position`, `facultatif`) VALUES
(1, 1, 1, 4, 'd\'eau tiède', 1, 0),
(2, 1, 2, 2, 'de sucre', 2, 0),
(3, 1, 2, 7, 'de levure active sèche traditionnel', 3, 0),
(4, 1, 2, 4, 'de lait', 4, 0),
(5, 1, 0.25, 4, 'de miel', 5, 0),
(6, 1, 4, 2, 'de sel', 6, 0),
(7, 1, 0.25, 4, 'd\'huile de canola', 7, 0),
(8, 1, 1, 4, 'd\'eau soit tiède ou froide ( elle est pour tempérer le liquide avant d\'y mettre la levure et les farines )', 8, 0),
(9, 1, 1, 1, 'oeuf', 9, 0),
(10, 1, 2.5, 4, 'de farine d\'épaute ou équivalent ( cette farine est fait de grains anciens, comme le kamut , le seigle ) ', 10, 1),
(11, 1, 0.25, 4, 'de graines de tournesol                ', 11, 0),
(12, 1, 0.25, 4, 'de graines de lin moulue', 12, 0),
(13, 1, 1.5, 4, 'de gruau ', 13, 0),
(14, 1, 5, 4, 'de farine blanche non blanchie', 14, 0),
(15, 2, 1, 4, 'd\'huile et/ou beurre', 1, 0),
(16, 2, 1.5, 4, 'de cassonade', 2, 0),
(17, 2, 2, 1, 'oeufs', 3, 0),
(18, 2, 0.5, 2, 'de vanille', 4, 0),
(19, 2, 0.5, 2, 'de sel', 5, 0),
(20, 2, 0.5, 2, 'de cannelle', 6, 0),
(21, 2, 1, 4, 'de noix', 7, 0),
(22, 2, 1, 4, 'de pépites de chocolat blanc', 8, 0),
(23, 2, 0.75, 4, 'de canneberges', 9, 0),
(24, 2, 0.75, 4, 'de coconut', 10, 0),
(25, 2, 1, 4, 'de gruau (si vous retirez le coconut, ajouter 1 tasse de plus de gruau)', 11, 0),
(26, 2, 1.25, 4, 'de farine', 12, 0);
